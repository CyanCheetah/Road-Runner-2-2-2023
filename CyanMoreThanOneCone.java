...
public class CyanMoreThanOneCone extends LinearOpMode {
    OpenCvCamera camera;
        ...
        if(tagOfInterest==null || tagOfInterest.id==left){
            ...
            Trajectory left1 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .addTemporalMarker(2.4, () -> {
                        ...
                        ElevatorMotor.setTargetPosition(ElevatorMotor.getTargetPosition()+2750);
                        ElevatorMotor.setPower(.4);
                    })
                    .build();
            Trajectory left9 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-5,-4,Math.toRadians(45)))
            ...
            Trajectory left3 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .addTemporalMarker(0.1, () -> {
                        ElevatorMotor.getCurrentPosition();
                        ElevatorMotor.setTargetPosition(ElevatorMotor.getTargetPosition()-2480);
                        ElevatorMotor.setPower(.4);
                    })
                    .build();
            ...
            Trajectory left5 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .addTemporalMarker(3, () -> {
                        ElevatorMotor.getCurrentPosition();
                        ElevatorMotor.setTargetPosition(ElevatorMotor.getTargetPosition()-1600);
                        ElevatorMotor.setPower(.4);
                    })
                    .build();
            ...
            Trajectory left6 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .build();
            Trajectory left7 = drive.trajectoryBuilder(new Pose2d())
                    .back(7.5)
